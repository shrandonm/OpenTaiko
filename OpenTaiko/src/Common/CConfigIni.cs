...
internal class CConfigIni : INotifyPropertyChanged {
	...
	public CTimingZones[] tzLevels = {
		...
		new CTimingZones(16, 42, 108), // Lv5 (Hard-Extreme + "Strict" mod (Tatsu))
	...
	public void t書き出し(string iniファイル名) {
		...
		sw.WriteLine();
		sw.WriteLine(
			"; Fun Mods (0 : None, 1 : Avalanche (random scroll speed per note/chip), 2 : Minesweeper (replace randomly notes by bombs), 3 : Force All Notes To Don)");
